...
namespace P6_2_1204026
{
    public partial class Form1 : Form
    {
        ...
        {
            string url = "server=localhost;userid=root;password=;database=p6_1204026";
            string myConnectionString = "integrated security=true;datasource=localhost;initial catalog=p6_1204026";
            MySqlConnection conn = new MySqlConnection(url);
